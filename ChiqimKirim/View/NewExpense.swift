...
//  ChiqimKirim
//
//  Created by Waris Ruzi on 2022/11/04.
//
...
struct NewExpense: View {
    ...
    func RightView()->some View{
        VStack{
            Label{
                TextField("ئەسكەرتمە يېزىڭ", text: $expenseViewModel.remark)
            ...
            .background{
                RoundedRectangle(cornerRadius: 12, style:
                        .continuous)
                        .fill(.white)
            }
        .padding(.top, 25)
        ...
        Label{
            DatePicker.init("", selection: $expenseViewModel.date,in:
                                Date.distantPast...Date(),displayedComponents: [.date])
